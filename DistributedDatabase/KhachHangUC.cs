...
namespace DistributedDatabase
{
    public partial class KhachHangUC : UserControl
    {
        ...
        public KhachHangUC(SqlConnection kn, DataRowView dataview, UpdateInterface infForm, MyStack mystack)
        {
            InitializeComponent();
            this.infForm = infForm;
            this.kn = kn;
            ...
            Console.WriteLine("ngaycap: " + dataValue);
        ...
        public void setBefore(SqlConnection kn, string branchCode, UpdateInterface infForm, MyStack mystack)
        {
            //InitializeComponent();
            this.kn = kn;
            this.infForm = infForm;
            ...
            cmndTxt.Text = "";
            sdtTxt.Text = "";
            ngaycapDateTime.Value = DateTime.Today;
        ...
        {
            //MessageBox.Show("Bat dau form chinh sua");
            //InitializeComponent();
            this.infForm = infForm;
            this.kn = kn;
            this.mystack = mystack;
            ...
            //Console.WriteLine("ngaycap: " + dataValue);
            //DateTime.TryParseExact(dataValue, pattern, null, DateTimeStyles.None, out parsedDate);
            //ngaycapDateTime.Value = DateTime.ParseExact("MM/dd/yyyy HH:mm:ss tt",dataValue, CultureInfo.InvariantCulture);
